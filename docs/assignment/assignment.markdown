...
You are *strongly encouraged* to produce a single, complete document using R Markdown.

**In any case, you have to submit <ins>all</ins> code, output, and substantive responses - everything you do must be fully replicable!**
...
[Take-Home Exam - Data Ex.5](https://bayreuth-politics.github.io/CI26/assignment/france.dta){: .btn .btn-blue }
